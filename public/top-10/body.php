...
<div class="text-center font-weight-bold">
    <h2 style="font-family:sans-serif" size="100">LOS</h2>
    <h1 style="font-family:Wide Latin">"BEASTS"</h1>
    <h2 style="font-family:sans-serif" >DE QUOOTER</h2>
</div>
...
<div class="row">
    ...
    <div class="col-sm">
        <div class="">
            <img class= "mb-1" src="../images/ganador01.png" width="33" height="47" class="" alt="">
...
<div class="row">
    <div class="col-sm ml-4">
        <div class="">
            <img class= "mb-1" src="../images/ganador02.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
                <p class="mb-0  ">2 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
                <footer class="blockquote-footer text-right ml-5">Nombre Usuario <cite title="Source Title">Fecha</cite></footer>
            </blockquote>
    ...
    <div class="col-sm">
        <div class="">
            <img class= "mb-1" src="../images/ganador03.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
...
<               <a href="" class="fa fa-thumbs-o-down" style="font-size:14px;color:red;text-decoration:none"></a></span>
    ...
    <div class="col-sm mr-4">
        <div class="">
            <img class= "mb-1" src="../images/ganador04.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
...
<div class="row">
    <div class="col-sm ml-4">
        <div class="">
            <img class= "mb-1" src="../images/ganador05.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
    ...
    <div class="col-sm">
        <div class="">
            <img class= "mb-1" src="../images/ganador06.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
...
<               <a href="" class="fa fa-thumbs-o-down" style="font-size:14px;color:red;text-decoration:none"></a></span>
    ...
    <div class="col-sm mr-4">
        <div class="">
            <img class= "mb-1" src="../images/ganador07.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
...
<div class="row">
    <div class="col-sm ml-4">
        <div class="">
            <img class= "mb-1" src="../images/ganador08.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
    ...
    <div class="col-sm">
        <div class="">
            <img class= "mb-1" src="../images/ganador09.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
...
<               <a href="" class="fa fa-thumbs-o-down" style="font-size:14px;color:red;text-decoration:none"></a></span>
    ...
    <div class="col-sm mr-4">
        <div class="">
            <img class= "mb-1" src="../images/ganador10.png" width="33" height="47" class="" alt="">
            <blockquote class="blockquote text-left border border-dark shadow p-3 mb-3 bg-white rounded">
