...
<div class="container target mt-5">
  ...
  <div class="row">
      ...
      <a href="/users" class="pull-right m-2"><img title="profile image" class="img-circle img-responsive" src="http://www.rlsandbox.com/img/profile.jpg"></a>
  </div><div class="row">
        
      
  <ul class="list-group m-2 col-12">
                <li class="list-group-item text-muted" contenteditable="false">Perfil</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Día registro</strong></span> 2.13.2014</li>
        ...
        <div class="row">
            ...
            <div class="container">
                <textarea id="congratulation-text" placeholder="Escribe algo que te identifique!"></textarea>
              </div>
              </div>
              </ul></div>
